...
<body>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item">
                        <a href="products.php?category=<?= htmlspecialchars($product_category) ?>" class="text-white">Home</a>
                    </li>
                    <li class="breadcrumb-item active text-white" aria-current="page"><?= htmlspecialchars($product_category) ?></li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container mt-4">
        <div class="d-flex gap-3 flex-md-row flex-column">
            ...
            <div class="col-md-6">
                <h1 class="text-capitalize"><?= htmlspecialchars($product_name) ?> - <span class='text-sm text-muted'><a href='store.php?id=<?=htmlspecialchars($poster_id) ?>'><?= htmlspecialchars($seller_details_name) ?></a></span></h1>
                ...
                <div class="price mb-3">
                    <?php if ($discountPercentage > 0): ?>
                        <del class="text-muted me-2">₦<?= htmlspecialchars($originalPrice) ?></del>
                        ₦<?= htmlspecialchars($discountedPrice) ?> <span class="badge bg-danger"><?= htmlspecialchars($discountPercentage) ?>% OFF</span>
                    <?php else: ?>
                        <i class="fas fa-naira-sign"></i> <?= htmlspecialchars($originalPrice); ?>
                    <?php endif; ?>
                </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <?php if ($_SESSION['user_id'] == $poster_id): ?>
                     ...
                     <?php else: ?>
                         <button id='<?= htmlspecialchars($productid)?>' class="btn btn-success btn-add flex-grow-1">Add to Cart</button>
                     <?php endif; ?>
                     <?php else: ?>
                ...
                <div class="mt-3">
                    ...
                    <a href="products.php?category=<?= htmlspecialchars($product_category) ?>" class="text-decoration-none"><?= htmlspecialchars($product_category) ?></a>
                </div>
            </div>
        </div>

        <!-- Tabs Section -->
        <div class="row mt-4 bg-danger w-100 py-2">
            <div class="col">
                <nav>
        ...
        <div class="tab-content" id="productTabsContent">
            ...
            <div class="tab-pane fade show active" id="description" role="tabpanel">
                <div class="d-flex justify-content-center container flex-md-row flex-column gap-3">
                    ...
                    <div class="w-100">
                        <img src="<?= htmlspecialchars($product_image); ?>" alt="<?= htmlspecialchars($product_name); ?>" class="product-image img-fluid mb-3">
